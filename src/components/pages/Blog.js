  ...
  return (
      ...
      <section className="work" id="work">
        ...
        <div className="projects">
          {/* Project One */}
            <a className="project" id='project-one' href="https://bmorrissey34.github.io/Movies-TV-Search/">
                <figure>
          ...
          {/* Project Two */}
          <a className="project" href="https://lijing-code.github.io/03-JS-Password-Generator/">
                    <figure>
          ...
          {/* Project Three */}
          <a className="project" href="https://lijing-code.github.io/04-Web-APIs-Code-Quiz/">
                    <figure>
          ...
          {/* Project Four */}
          <a className="project"  href=" https://lijing-code.github.io/05-Third-Party-APIs-Work-Day-Scheduler/">
                    <figure>
          ...
          {/* Project Five */}
          <a className="project" href="https://lijing-code.github.io/06-Server-Side-APIs-Weather-Dashboard/">
                    <figure>
